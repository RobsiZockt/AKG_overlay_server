 ...
 async function fetchData() {
	...
	return h("div",{id:"container",className:"w-[500px] h-[200px] flex flex-col space-y-2"},
		...
		h("div",{id:"T1",className:"flex w-full h-[50%] justify-center"},
			...
			h("span", { className: "font-arial text-white w-full text-[50px] pl-2" }, matchup.blue),
			h("span", { className: "ml-2 font-arial text-[50px] text-white items-center justify-center" }, matchup.blue_score)
		),
		h("div",{id:"T1",className:"flex w-full h-[50%]"},
			h("img",{id:"t1_logo",className:"h-auto aspect-square object-cover",src:matchup.red_logo}),
			h("span", { className: "font-arial text-white w-full text-[50px] pl-2" }, matchup.red),
			h("span", { className: "ml-2 font-arial text-[50px] text-white items-center justify-center" }, matchup.red_score)
		)
	)
}
